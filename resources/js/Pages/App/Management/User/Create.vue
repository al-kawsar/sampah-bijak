...
const handleImageUpload = (info) => {
  if (info.file.status === "done") {
    ...
    form.value.profile.profile_picture = info.file.response.path;
  }
};
  ...
  <div class="p-6">
    <a-card title="Create New User" class="max-w-3xl mx-auto">
      <a-form :model="form" layout="vertical" @finish="handleSubmit">
        <!-- User Information -->
        <a-divider>User Information</a-divider>
        ...
        <!-- Profile Information -->
        <a-divider>Profile Information</a-divider>
        ...
        <a-form-item
          ...
          :rules="[{ required: true }]"
        >
          <a-input v-model:value="form.profile.full_name" placeholder="Enter full name">
            <template #prefix>
              <UserOutlined />
            </template>
          </a-input>
        ...
        >
          <a-input
            v-model:value="form.profile.phone_number"
        ...
        <!-- <a-form-item label="Profile Picture" name="profile.profile_picture">
          <a-upload
