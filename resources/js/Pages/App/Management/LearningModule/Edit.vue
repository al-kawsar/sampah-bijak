<script setup>
  ...
  import { CloudUploadOutlined, SaveOutlined, ArrowLeftOutlined, PictureOutlined } from "@ant-design/icons-vue";
  ...
  const imageUrl = ref(props.module.thumbnail);
  ...
  const formState = reactive({
    ...
    thumbnail: props.module.thumbnail,
  });
...
// Editor configuration
  const editorConfig = {
    ...
    toolbar: "formatselect | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | removeformat | help",
  };
  ...
  const onSubmit = async () => {
    ...
    axios
    .put(route("app.learnings.update", { id: formState.id }), formData, {
      headers: {
...
<template>
  <div class="create-module-container">
    <div class="page-header">
      ...
      <Progress :percent="formCompletion" size="small" :show-info="false" class="completion-progress" />
    </div>
